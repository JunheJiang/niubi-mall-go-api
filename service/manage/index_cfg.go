...
func (m *AdminIndexConfigService) DeleteMallIndexConfig(ids request.IdsReq) (err error) {
...
func (m *AdminIndexConfigService) GetMallIndexConfig(id uint) (err error, mallIndexConfig manage.MallIndexConfig) {
